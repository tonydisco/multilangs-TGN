    ...
    <div>
      <section className="hero">
        <div className="relative">
          ...
          >
            <PureImage url="/landing/HERO-GRID.svg" />
          </div>
          <div>
            <div
              style={{
            ...
            <div>
              <PureImage url="/landing/HERO-BANNER.svg" />
            </div>
          </div>
        </div>
      </section>
      <section className="about-us">
        <div
          style={{
            background: 'url(/landing/ABOUT-US-BD.svg)',
        ...
        >
          <div className="flex justify-center items-center mx-auto p-24 max-w-6xl">
            <div className="rounded-[10px] bg-browMain p-8 text-white">
      ...
      <section className="vision-mission">
        ...
        >
          ...
          >
            <PureImage url="/landing/GRID-VISION.svg" />
          </div>
          <div className="flex justify-center  mx-auto p-10 max-w-6xl gap-5 item-stretch">
            <div
              ...
              style={{
                background: 'url(/landing/VISION.svg)',
                backgroundSize: 'cover',
                backgroundRepeat: 'no-repeat',
                backgroundPosition: 'center'
              }}
            ...
            <div
              className="rounded-[24px] bg-browMain p-4 text-white flex-1 relative"
              style={{
                background: 'url(/landing/MISSION.svg)',
                backgroundSize: 'cover',
                backgroundRepeat: 'no-repeat',
                backgroundPosition: 'center'
              }}
